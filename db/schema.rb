...
ActiveRecord::Schema.define(:version => 20140512134907) do
  ...
  create_table "refinery_new_player_inquiries", :force => true do |t|
    t.string   "name"
    t.string   "surname"
    t.integer  "phone"
    t.string   "email"
  ...
  add_index "refinery_new_player_inquiries", ["id"], :name => "index_refinery_new_player_inquiries_on_id"
  ...
  create_table "refinery_players", :force => true do |t|
    t.string   "name"
    t.string   "surname"
    t.string   "email"
    t.integer  "age"

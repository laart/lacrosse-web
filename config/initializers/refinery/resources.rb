...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "0e44e148e457e81cfb5a109ce1a1ca2d9ac88ea0622644c3"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/home/laacis/Desktop/BD/rickrockstar/public/system/refinery/resources"
